...
const translations: Record<Language, Translations> = {
    fr: {
        ...
        'projects.eccforum.description': 'Site web pour le Forum des Entreprises de l\'École Centrale Casablanca : présentation, CVthèque, dépôt de candidatures pour les entreprises visiteuses.',
        ...
        'projects.django.description': 'Application web éducative proposant un test initial puis des problèmes adaptés au niveau de l\'utilisateur, qui évolue selon ses réponses.',
        'projects.media.title': 'Lecteur multimédia web (JavaScript)',
        'projects.media.description': 'Lecteur multimédia local en JavaScript vanilla, intégrant aussi les API YouTube et Spotify.',
        'projects.game2048.title': 'Jeu 2048 (C++/QML)',
        'projects.game2048.description': 'Développement d\'un jeu 2048 interactif en C++ et QML.',
        'projects.portfolio.title': 'Portfolio personnel (React/TypeScript)',
        'projects.portfolio.description': 'Ce portfolio interactif, multilingue et responsive, développé avec React, TypeScript, Material-UI et animations modernes.',
    ...
    en: {
        ...
        'projects.eccforum.description': 'Website for the École Centrale Casablanca Business Forum: presentation, CV database, application submission for visiting companies.',
        ...
        'projects.django.description': 'Educational web application offering an initial test followed by problems adapted to the user\'s level, evolving based on their responses.',
        'projects.media.title': 'Web Media Player (JavaScript)',
        'projects.media.description': 'Local media player in vanilla JavaScript, also integrating YouTube and Spotify APIs.',
        'projects.game2048.title': '2048 Game (C++/QML)',
        'projects.game2048.description': 'Development of an interactive 2048 game in C++ and QML.',
        'projects.portfolio.title': 'Personal Portfolio (React/TypeScript)',
        'projects.portfolio.description': 'This interactive, multilingual, and responsive portfolio was developed with React, TypeScript, Material-UI, and modern animations.',
        'projects.buttons.code': 'Code',
        'projects.buttons.demo': 'Demo'
    }
};
